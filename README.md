...
```
npm install ckeditor5-decouplededitor-ckonline-build
```
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `ot1fq1uxs69y-g1o85s4bhz92`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
